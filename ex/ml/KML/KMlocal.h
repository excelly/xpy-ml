...
protected:					// overridden by subclasses
	...
	if (curr.getDBIndex() < best.getDBIndex()) {	// is current distortion lower?
...
protected:					// overridden methods
    ...
    virtual void tryAcceptance() { 		// test acceptance
	if (curr.getDBIndex() < best.getDBIndex()) {	// current distortion lower?
...
protected:					// overridden methods
	...
	if (save.getDBIndex() < best.getDBIndex()) {	// new best?
	  best = save;
	}
      }
...
protected:					// overridden methods
    ...
    virtual void tryAcceptance() { 		// test acceptance
      if (curr.getDBIndex() < best.getDBIndex()) {	// new best?
	best = curr;
      }
    }
};
